...
Функция ДобавитьВербВыражение(ВербВыражение)
	...
	Возврат ЭтаФорма.Группа().Добавить(ВербВыражение.ПолучитьСтроку()).КонецГруппы();
...
//   Форма   - эта форма
//
Функция Потом(ВхСтрока) Экспорт

	Возврат Затем(ВхСтрока);
